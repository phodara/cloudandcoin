...
- Shows BBC World news headlines with one-line summaries
- Supports touch navigation between weather, crypto, stocks, pair trading, signals, system status, and news screens
